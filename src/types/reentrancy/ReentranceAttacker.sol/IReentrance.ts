...
export interface IReentranceInterface extends utils.Interface {
  functions: {
  ...
  getFunction(
    nameOrSignatureOrTopic: "balanceOf" | "donate" | "withdraw"
  ): FunctionFragment;
...
export interface IReentrance extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IReentranceInterface;
